  ...
  theme: {
    extend: {
      colors: {
        ...colors,
        primary: {
            100: lighten('#97c0d3', 0.4),
            200: lighten('#97c0d3', 0.3),
            300: lighten('#97c0d3', 0.2),
            400: lighten('#97c0d3', 0.1),
            500: '#97c0d3',
            600: darken('#97c0d3', 0.1),
            700: darken('#97c0d3', 0.2),
            800: darken('#97c0d3', 0.3),
            900: darken('#97c0d3', 0.4),
        },
        secondary: {
      ...
      width: { templateValue: '80%', amazonValue: '80%'}
    },
    truncate: {
      lines: {
          2: '2',
